package me.kimyounghan.examples.lib;
...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<me.kimyounghan.examples.lib.HelloRequest,
      me.kimyounghan.examples.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = me.kimyounghan.examples.lib.HelloRequest.class,
      responseType = me.kimyounghan.examples.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<me.kimyounghan.examples.lib.HelloRequest,
      me.kimyounghan.examples.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<me.kimyounghan.examples.lib.HelloRequest, me.kimyounghan.examples.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<me.kimyounghan.examples.lib.HelloRequest, me.kimyounghan.examples.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.kimyounghan.examples.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.kimyounghan.examples.lib.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(me.kimyounghan.examples.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<me.kimyounghan.examples.lib.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                me.kimyounghan.examples.lib.HelloRequest,
                me.kimyounghan.examples.lib.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractBlockingStub<SimpleBlockingStub> {
    ...
    /**
     */
    public me.kimyounghan.examples.lib.HelloReply sayHello(me.kimyounghan.examples.lib.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractFutureStub<SimpleFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<me.kimyounghan.examples.lib.HelloReply> sayHello(
        me.kimyounghan.examples.lib.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((me.kimyounghan.examples.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<me.kimyounghan.examples.lib.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return me.kimyounghan.examples.lib.HelloWorldProto.getDescriptor();
    }
